        ...
        def add_on_policy_distillation_arguments(parser):
            ...
            parser.add_argument(
                ...
                help=(
                    ...
                    "require --opd-top-k-strategy only_stu. When unset, all samples are "
...
def miles_validate_args(args):
    ...
    if args.use_opd:
        ...
        if args.opd_teacher_urls:
            ...
            if has_ensemble_group and args.opd_log_prob_top_k > 0 and args.opd_top_k_strategy != "only_stu":
                raise ValueError(
                    "Teacher ensembles (--opd-teacher-urls groups with multiple URLs) require "
                    "--opd-top-k-strategy only_stu: every group member must be scored at the "
        ...
        if args.opd_topk_tail_bucket:
            ...
            if args.opd_top_k_strategy not in ("only_stu", "intersection"):
                raise ValueError(
                    "--opd-topk-tail-bucket requires --opd-top-k-strategy only_stu or intersection: the k+1 "
